...
const SideNav = () => {
  ...
  const TutorNavigation = [
    ...
    },
    {
      href: '/tutor/wallet',
      name: 'Wallet',
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-wallet2" viewBox="0 0 16 16">
    ...
    },
    {
      href: '/tutor/message',
      name: 'Message',
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chat-dots" viewBox="0 0 16 16">
  ...
  const AdminNav = [
    ...
    },
    {
      href: '/admin/review',
      name: 'Review',
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear-wide" viewBox="0 0 16 16">
    ...
    <aside className='h-screen fixed lg:w-[20%] w-full bg-[#F8F7F4] sm:mt-4 shadow-md p-6'>
      ...
      <div className="flex-1 flex flex-col h-full my-6 overflow-auto">
        <ol className="text-sm font-medium flex-1">
          ...
          {pathname.includes('applicant') && <li className='my-3' >
            <a href='https://project.experthubllc.com/' target='_blank' className={"flex items-center gap-x-2 text-gray-600 p-2 rounded-lg"}>
