    ...
    <div className='lg:w-[32%] my-3' key={event._id}>
      ...
      <div>
        ...
        <div className='flex justify-between my-1'>
          ...
          {event.fee - event.strikedFee === 0 ? <p className='text-sm text-[#0BC01E]'>Free</p> : <p className='text-sm'><span>₦ {event.fee - event.strikedFee}</span> <span className='line-through	text-gray'>{event.fee}</span></p>}
