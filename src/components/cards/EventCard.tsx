        ...
        <div className='flex justify-between my-3'>
          <div>
            ...
            <div className='flex ml-1'>
              {event.enrolledStudents.slice(0, 6).map((event: { _id: React.Key | null | undefined; profilePicture: string | undefined; }) => <img key={event._id} src={event.profilePicture  ? event.profilePicture : '/images/user.png'} className='w-5 rounded-full h-5 -ml-1' alt="" />)}
