      ...
      ? [
          ...
          },
          {
            ...
            label: (
              <p
                className={`${
                  workspace.type === `online` ? `cursor-not-allowed` : ``
                }`}
          ...
          {
            key: "7",
            label: <p onClick={() => setResources(true)}>Add Resources</p>,
          },
        ]
      : []),
  ];
    ...
    <div className="p-2 w-full shadow-md my-3 rounded-md bg-white">
      <div className="flex my-2">
        ...
        <img
          className="w-6 h-6 rounded-full"
          src={
            typeof workspace.thumbnail === "object" && workspace.thumbnail.url
      ...
      <h3 className="font-medium my-3">
        ...
        {pathname.includes("courses") && pathname.includes("admin") ? (
          <Link href={`/admin/${workspace._id}?page=${workspace.type}`}>
