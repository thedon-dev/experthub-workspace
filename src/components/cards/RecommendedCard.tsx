    ...
    <div className="lg:flex justify-between border p-3 my-3 lg:w-[49%] rounded-md border-[#1E1E1E75]">
      ...
      <div className="lg:mx-4 sm:my-2 w-full">
        <p className="text-primary text-sm">
          {course.category}.{" "}
          <span className="text-black"> by {course.instructorName}</span>
        </p>
        ...
        <div>
          ...
          {course.fee === 0 ? (
            ...
            <p className="text-sm">
              ...
              <span className="line-through	text-gray">{course.strikedFee}</span>
            </p>
          )}
        </div>
        <div className="flex">
      ...
      <div className="lg:w-52 my-auto">
        <button
          ...
          className="p-2 w-full my-1 bg-primary rounded-sm"
        >
          Enrol Now
        </button>
        <button
          onClick={() => setAppointment(true)}
          className="p-2 w-full bg-primary rounded-sm my-1"
        >
          Enquire
        </button>
        <button
