      ...
      <div className='p-4 z-50 flex justify-between shadow-[0px_1px_2.799999952316284px_0px_#1E1E1E38]'>
        ...
        <div className='flex'>
          ...
          <div className='flex gap-8 justify-between'>
            <a className='text-center flex items-center flex-col gap-2' href={`https://experthubllc.com/feeds?tid=${user.accessToken}`}>
            ...
            <a className='text-center flex items-center flex-col gap-2 text-[16px] ' href={`https://experthubllc.com/org?tid=${user.accessToken}`} >
